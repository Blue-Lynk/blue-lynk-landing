...
<template>
  <section class="divided dark sections mid-sm" id="contacto">
    <!-- INFO -->
    <div>
      ...
      <div class="contact-info">
        <div class="contact-info-item">
          <a href="mailto:info@bluelynk.dev">info@bluelynk.dev</a>
        </div>
        <div class="contact-info-item">
          <a href="tel:+51987151798">+51 987 151 798</a>
        </div>
        <div class="contact-info-item">
          Lima, Perú
        </div>
    ...
    <form class="cform" @submit.prevent="onSubmit">
      ...
      <div class="cform-row">
        <div>
          ...
          <input v-model="form.name" type="text" id="name" name="name" placeholder="Tu nombre"
            autocomplete="given-name" />
        </div>

        <div>
          <label for="lastname">Apellido</label>
          <input v-model="form.lastname" type="text" id="lastname" name="lastname" placeholder="Tu apellido"
      ...
      <div class="cform-row">
        <div>
          ...
          <input v-model="form.company" type="text" id="company" name="company" placeholder="Nombre de tu empresa"
            autocomplete="organization" />
        </div>

        <div>
          <label for="email">Email</label>
          <input v-model="form.email" type="email" id="email" name="email" placeholder="tu@email.com"
            autocomplete="email" />
        </div>
      </div>
      ...
      <select v-model="form.service" id="service" name="service">
        ...
        <option>Desarrollo de soluciones</option>
      ...
      <div style="margin-top:1.5rem">
        <button class="btn-p-dark" style="width:100%;padding:.8rem" :disabled="loading">
